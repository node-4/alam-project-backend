...
router.post("/admin/Brand/addBrand", [authJwt.verifyToken], upload.single('image'), auth.createBrands);
router.get("/admin/Brand/allBrand", auth.getBrands);
router.put("/admin/Brand/updateBrand/:id", [authJwt.verifyToken], upload.single('image'), auth.updateBrand);
router.delete("/admin/Brand/deleteBrand/:id", [authJwt.verifyToken], auth.removeBrand);
